...
bool test_back_prop() {
    ...
    back_prop_output_t other_results = back_prop_one_layer(3, forward_prop_output, neural_net.get_weights());
...
bool test_back_prop_two_layer() {
    bool test_failed = false;

    auto input_pixels = get_input_pixels();

    std::vector<size_t> layers {13};
    ...
    back_prop_output_t other_results = back_prop_two_layer(3, forward_prop_output, neural_net.get_weights());
...
int main() {
    ...
    std::cout << test_back_prop_two_layer() << '\n';
